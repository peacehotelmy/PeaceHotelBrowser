...
init().then(() => console.debug("Launcher home initialized")), document.getElementById("zoomIn").addEventListener("click", zoomIn), document.getElementById("zoomOut").addEventListener("click", zoomOut), document.getElementById("clearCache").addEventListener("click", clearCache), document.getElementById("fullScreen").addEventListener("click", fullScreen), document.getElementById("reload").addEventListener("click", () => {
    reload(!0)
}), t.on("reloadSession", () => {
    reload(!1, !0)
});